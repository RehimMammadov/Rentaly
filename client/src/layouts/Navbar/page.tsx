    ...
    <>
          ...
          <ul id="navbar" className="max-w-[35%] flex justify-between gap-12">
            {navbarData &&
              navbarData.map((navbar) => (
                <li className="flex justify-between gap-1 items-center transition duration-300 text-white hover:text-[#1ecb15]">
                  <Link className="font-medium text-xl" href={navbar.link}>
                    {navbar.title}
                  </Link>{" "}
          ...
          >
            <button className="cursor-pointer relative">
              <Link href={"/favourites"}>
                <CiHeart className="text-3xl cursor-pointer fill-white" />
              </Link>
            ...
            <button className="cursor-pointer relative">
              <Link href={"/cart"}>
                <CiShoppingCart className="text-3xl cursor-pointer fill-white" />
              </Link>
              <div className="w-5 absolute top-[-6px] right-[-8px] h-5 rounded-[50%] bg-[#1ecb15]">
                <p className="text-white text-[12px]">0</p>
              </div>
            ...
            <button className="cursor-pointer">
              <Link href={"/sign-in"}>
                <CiUser className="text-3xl cursor-pointer fill-white" />
              </Link>
            </button>
          </div>
          <HiBars4
      ...
      >
        <ul className="text-white flex flex-col gap-6">
          {navbarData &&
            navbarData.map((navbar) => (
              <li className="flex gap-1 items-center transition duration-300 hover:text-[#1ecb15]">
                <Link className="font-medium text-xl" href={navbar.link}>
                  {navbar.title}
                </Link>{" "}
                <MdKeyboardArrowDown className="text-xl" />
          ...
          <button className="cursor-pointer">
            <Link
              className="flex items-center gap-1  transition duration-300 hover:text-[#1ecb15]"
              href={"/favourites"}
            >
